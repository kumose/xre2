...
//    KCHECK(RE2::FullMatch("hello", "h.*o"));
//
// Example: unsuccessful match (requires full match):
//    KCHECK(!RE2::FullMatch("hello", "e"));
//
// -----------------------------------------------------------------------
...
//
// Example:
//    KCHECK(RE2::FullMatch(utf8_string, RE2(utf8_pattern)));
//    KCHECK(RE2::FullMatch(latin1_string, RE2(latin1_pattern,
//                                                 RE2::Latin1)));
//
// -----------------------------------------------------------------------
// SUBMATCH EXTRACTION:
...
//    int i;
//    std::string s;
//    KCHECK(RE2::FullMatch("ruby:1234", "(\\w+):(\\d+)", &s, &i));
//
// Example: extracts "ruby" into "s" and no value into "i"
//    std::optional<int> i;
//    std::string s;
//    KCHECK(RE2::FullMatch("ruby", "(\\w+)(?::(\\d+))?", &s, &i));
//
// Example: fails because string cannot be stored in integer
//    KCHECK(!RE2::FullMatch("ruby", "(.*)", &i));
//
// Example: fails because there aren't enough sub-patterns
//    KCHECK(!RE2::FullMatch("ruby:1234", "\\w+:\\d+", &s));
//
// Example: does not try to extract any extra sub-patterns
//    KCHECK(RE2::FullMatch("ruby:1234", "(\\w+):(\\d+)", &s));
//
// Example: does not try to extract into NULL
//    KCHECK(RE2::FullMatch("ruby:1234", "(\\w+):(\\d+)", NULL, &i));
//
// Example: integer overflow causes failure
//    KCHECK(!RE2::FullMatch("ruby:1234567891234", "\\w+:(\\d+)", &i));
//
...
//      KCHECK(RE2::PartialMatch("hello", "ell"));
//
// Example: find first number in a string
//      int number;
//      KCHECK(RE2::PartialMatch("x*100 + 20", "(\\d+)", &number));
...
// Example:
//   int a, b, c, d;
//   KCHECK(RE2::FullMatch("100 40 0100 0x40", "(.*) (.*) (.*) (.*)",
...
namespace xre2 {
    ...
    public:
        ...
        xre2::Regexp *Regexp() const { return entire_regexp_; }
    ...
    public:
        ...
        //
        //   std::string s = "yabba dabba doo";
        //   KCHECK(RE2::GlobalReplace(&s, "b+", "d"));
        //
        ...
        //
        // Passing text == std::string_view() will be handled like any other
        ...
        public:
            ...
            Options() : max_mem_(kDefaultMaxMem),
    ...
    private:
        ...
        xre2::Prog *ReverseProg() const;

        // First cache line is relatively cold fields.
        const std::string *pattern_; // string regular expression
        Options options_; // option flags
        xre2::Regexp *entire_regexp_; // parsed regular expression
        xre2::Regexp *suffix_regexp_; // parsed regular expression, prefix_ removed
        ...
        xre2::Prog *prog_; // compiled program for regexp

        // Reverse Prog for DFA execution only
        mutable xre2::Prog *rprog_;
    ...
    namespace re2_internal {
        ...
        template<>
        struct Parse3ary<std::string_view> : public std::true_type {
        };
        ...
        template<typename T>
        struct Parse3ary<std::optional<T> > : public Parse3ary<T> {
        };

        template<typename T>
        struct Parse4ary<std::optional<T> > : public Parse4ary<T> {
        };
