...
TURBO_FLAG(int, regexpseed, 404, "Random regexp seed.");
TURBO_FLAG(int, regexpcount, 100, "How many random regexps to generate.");
TURBO_FLAG(int, stringseed, 200, "Random string seed.");
TURBO_FLAG(int, stringcount, 100, "How many random strings to generate.");
...
static void RandomTest(int maxatoms, int maxops,
  ...
  t.RandomStrings(turbo::get_flag(FLAGS_stringseed),
                  turbo::get_flag(FLAGS_stringcount));
  t.GenerateRandom(turbo::get_flag(FLAGS_regexpseed),
                   turbo::get_flag(FLAGS_regexpcount));
